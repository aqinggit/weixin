...
<header class="jjk-header">
    <div class="viewport">
        <div class="layout-back" onclick="history.go(-1)" >
            <i class="fa fa-chevron-left"></i>
        </div>
        <div class="layout-middle">
            <div class="text"><?php echo $this->mobileTitle ? $this->mobileTitle : '个人中心';?></div>
        </div>
    </div>
</header>
<?php echo $content; $this->renderPartial('/layouts/_nav');echo zmf::config('tongji');$this->endContent(); ?>
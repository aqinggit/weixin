            ...
            <?php if($canLogin){$form=$this->beginWidget('CActiveForm', array(
                ...
                <div class="form-body">
                    ...
                    <div class="form-group" id="use-passwd">
                        ...
                        <p class="ex-tip">
                            <a href="javascript:;" onclick="toggleArea('passwd')">用手机验证码登录</a>
                    ...
                    <div id="use-sms">
                        <div class="form-group">
                            ...
                            <button type="button" class="msgBtn disabled sendSms-btn" data-target="login-phone" data-type="login" disabled="disabled">发送验证码</button>

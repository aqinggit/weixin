...
//        if (!isset($uptype) OR ! in_array($uptype, array('posts','siteinfo','product','faceImg'))) {
...
//        }
        ...
        if (move_uploaded_file($_FILES[$fileholder]["tmp_name"], $origin . $fileName)) {
            ...
            if ($model->save()) {
                ...
                if($uptype=='timeline'){
                    //$html=  $this->renderPartial('/timeline/_addImg',array('data'=>$_attr),true);
                }else{

...
class LinksController extends Admin {
    ...
    public function actionCreate($id = '') {
        ...
        if (isset($_POST['Links'])) {
            if (strpos($_POST['Links']['url'],'http://') === false && strpos($_POST['Links']['url'],'https://') === false) {
                $_POST['Links']['url'] = 'http://' . $_POST['Links']['url'];
            }
            if (strpos($_POST['Links']['position'],'http://') === false && strpos($_POST['Links']['position'],'https://') === false) {
                $_POST['Links']['position'] = 'http://' . $_POST['Links']['position'];
            }
            $_POST['Links']['hashUrl'] = Tdk::returnHashLink($_POST['Links']['position']);
            $_POST['Links']['hashCode'] = $_POST['Links']['hashUrl'] != '' ? md5($_POST['Links']['hashUrl']) : '';
    ...
    public function actionIndex() {
        $select = "id,title,url,logo,cTime,expritedTime,position,platform";
        $model = new Links;

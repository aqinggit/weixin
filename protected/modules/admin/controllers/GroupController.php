...
class GroupController extends Admin {
    ...
    public function actionDelete($id) {
        ...
        if($info->delete()){
            GroupGifts::model()->deleteAll('groupid='.$info['id']);
            GroupLevels::model()->deleteAll('gid='.$info['id']);
            GroupPowers::model()->deleteAll('gid='.$info['id']);
            GroupTasks::model()->deleteAll('gid='.$info['id']);
        }
        if ($this->isAjax) {

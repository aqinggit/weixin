...
$form = $this->beginWidget('CActiveForm', array(
    ...
    'action' => Yii::app()->createUrl('/admin/keywords/index'),
    ...
    <div class="form-group">
        <span class="dropdown" >
            <a href="#" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                导入词库<span class="caret"></span>
            </a>
            <ul class="dropdown-menu">
                <li><?php echo CHtml::link('栏目',array('intoColumn'),array('class'=>'','confirm'=>'确定？'));?></li>
                <li><?php echo CHtml::link('标签',array('intoTags'),array('class'=>'','confirm'=>'确定？'));?></li>
                <li><?php echo CHtml::link('地区',array('intoArea'),array('class'=>'','confirm'=>'确定？'));?></li>
                <li role="separator" class="divider"></li>
                <li><?php echo CHtml::link('批量导入',array('multi'));?></li>
            </ul>
        </span>
    </div>
</div>

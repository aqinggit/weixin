...
<div class="fixed-width-group">
    ...
    <?php echo CHtml::textField("type",$_GET["type"],array("class"=>"form-control","placeholder"=>$model->getAttributeLabel("type")));?></div>
...
<?php $this->endWidget(); ?>
 ...
 <table class="table table-hover table-striped">
    <tr>
                ...
                <th ><?php echo $model->getAttributeLabel("answers");?></th>
    ...
    <tr>
                ...
                <td><?php echo Questions::Status($data->status);?></td>
                <td><?php echo $data->UserInfo->truename;?></td>
                <td><?php echo $data->answers;?></td>
                <td><?php echo $data->score;?></td>
                <td><?php echo Questions::Type($data->type);?></td>
                <td>

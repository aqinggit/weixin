...
$tags= Tags::getAllByType(Column::CLASSIFY_POST, $model->id);
?>
<div class="form">
    ...
    <div class="row">
        ...
        <div class="col-xs-4 col-sm-4">
            <div class="form-group">
                ...
                <?php echo $form->dropDownlist($model,'typeId', Column::listClassifyFirst(Column::CLASSIFY_POST),array('class'=>'form-control','empty'=>'--选择分类--')); ?>

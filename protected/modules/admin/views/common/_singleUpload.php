...
<a class="btn btn-default fileinput-button" href="javascript:;" onclick="selectAttaches(false,'avatar',{inputId:'<?php echo CHtml::activeId($model,$fieldName);?>',targetHolder:'<?php echo $targetHolder;?>'})">

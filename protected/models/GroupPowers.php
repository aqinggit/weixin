...
class GroupPowers extends CActiveRecord {
    ...
    public function relations() {
        ...
        return array(
            'groupInfo' => array(static::BELONGS_TO, 'Group', 'gid'),
            'typeInfo' => array(static::BELONGS_TO, 'GroupPowerTypes', 'tid'),
        );
    }
    ...
    public static function cacheActions($groupid) {
        static::getGroupActions($groupid);
        return true;
    }
    ...
    public static function getGroupActions($groupid) {
        ...
        if (!$items) {
            $actions = static::_getGroupActions($groupid);
    ...
    public static function checkAction($userInfo, $action) {
        ...
        $actions = static::getGroupActions($userInfo['groupid']);
    ...
    public static function link($action, $userInfo, $text, $url = '#', $htmlOptions = array(), $showText = false) {
        ...
        return static::checkAction($userInfo, $action) ? CHtml::link($text, $url, $htmlOptions) : ($showText ? $text : '');
    }

...
?>
<textarea id="<?php echo CHtml::activeId($model,$attri);?>" name="<?php echo CHtml::activeName($model,$attri);?>">
<?php echo $content;?>
</textarea>
...
var tipImgUploadUrl="<?php echo $upurl;?>";
  $(function(){
    UM.registerUI('insertMyImg',
        function(name) {
            var me = this;
            var $btn = $.eduibutton({
                icon : 'image',
                click : function(){
                   selectAttaches(false,'article',{});
                },
                title: '从素材库插入图片'
            });
    ...
    myeditor=UM.getEditor('<?php echo CHtml::activeId($model,$attri);?>', {
       ...
       <?php }elseif($imgOnly){?>
           toolbar: ["image"],            
       <?php }else{?>
           //toolbar: ["bold","italic","underline","|","paragraph","|","insertorderedlist","insertunorderedlist","justifyleft","justifycenter","justifyright","justifyjustify","horizontal","|","link","unlink","image","insertMyImg"],
           toolbar: ["paragraph","bold","unlink","image","insertMyImg"],
       <?php }?>       
       lang:'zh-cn', //语言
       wordCount:true, //关闭字数统计       
       initialFrameWidth:<?php echo isset($editorWidth) ? $editorWidth : 780;?>, //宽度
       ...
       initialStyle:'.edui-container .edui-editor-body{background:transparent !important}.edui-editor-body .edui-body-container p{font-size:13px;line-height:1.75;word-break: break-all;}.edui-container .edui-toolbar{z-index:1 !important}',
